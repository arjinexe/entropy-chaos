...
class EntropyRunner:
            ...
            if cfg.rate_limit_check and schema.endpoints:
                ...
                for ep in sample:
                    ...
                    try:
                        ...
                        detector = DetectorClass(url, timeout=cfg.timeout, verify_ssl=cfg.verify_ssl, proxy_url=cfg.proxy_url)
    ...
    def _parse_schema(self) -> APISchema:
        ...
        if cfg.spec_file:
            ...
            return OpenAPIParser.from_file(p).parse()  # Active discovery — no spec needed
