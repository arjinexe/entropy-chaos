...
def test_sarif_output_structure():
    ...
    try:
        ...
        assert_eq(runs[0]["tool"]["driver"]["version"], "0.4.2")
...
def test_cli_version_flag():
    ...
    assert_true(
        "0.4.2" in result.stdout or "0.4.2" in result.stderr,
        f"Version output should contain 0.4.2. stdout={result.stdout!r} stderr={result.stderr!r}"
    )
